...
Import dans chaque page : from utils.styles import apply_styles, apply_header
"""
...
.stCode code  { color: #e0e0e0 !important; }
...
.doc-card h4 { color: #00D4FF !important; font-size: 20px; font-weight: 700; margin: 0 0 12px 0; }
.doc-card p  { color: rgba(255, 255, 255, 0.85) !important; font-size: 14px; line-height: 1.6; margin: 0; }
...
/* ════════════════════════════════════════════
   INPUTS / ENCARTS INTERACTIFS
   Règle : fond suffisamment opaque pour
   contraster sur n'importe quel fond sombre.
   ════════════════════════════════════════════ */
...
[data-testid="stFileUploader"] {
    ...
    border: 2px dashed rgba(0, 212, 255, 0.45) !important;
...
/* Bouton Browse — toujours visible */
